...
export default function NewRepairPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const repair = result;
      toast.success(`Repair ${repair.repairNumber} created successfully`);
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-6 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-3xl font-bold">New Repair Job</h1>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Repair Intake Form</CardTitle>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="grid gap-6 md:grid-cols-2">
            ...
            <div className="md:col-span-2 space-y-2">
              <Label htmlFor="solution">Solution (if known)</Label>
              <Textarea 
                id="solution" 
